...
const brief = {
  "slug": "phone-total-cost-calculator",
  "productType": "calculator",
  "title": "Phone Total Cost Calculator",
  "description": "Calculate the estimated total cost of a phone with down payment, installments, interest, and accessories.",
  "keywords": [
    "phone cost calculator",
    "monthly phone payment calculator",
    "phone installment calculator"
  ],
  "audience": "Shoppers comparing phone payment plans, installments, accessories, and upfront costs",
  "trendAngle": "Phone buyers are comparing installment offers and total ownership costs before upgrading devices.",
  "features": [
    "Monthly payment estimate",
    "Total cost estimate",
    "Accessory cost inclusion",
    "Finance disclaimer"
  ],
  "inputs": [
    {
    ...
    {
      "id": "accessories",
      "label": "Accessories and setup cost",
      "type": "number",
      "defaultValue": 80
    }
  ],
  "outputs": [
    ...
    {
      "id": "total-cost",
      "label": "Estimated total phone cost"
    }
  ],
  "faq": [
    {
      "question": "Does this include taxes and carrier fees?",
      "answer": "Only if you add them to the phone price or accessory fields. Real offers may include taxes, activation fees, and plan charges."
    },
    {
      "question": "Is the interest calculation exact?",
      "answer": "No. It is a simple estimate for comparison. Lenders and carriers may calculate financing differently."
    },
    {
      "question": "Should I use this before buying a phone?",
      "answer": "Yes, it can help compare options, but always check the official contract and payment terms."
    }
  ],
  "disclaimer": "This calculator is for planning only and is not financial advice. Confirm official installment, tax, fee, and interest terms before purchase."
} as BriefData;
const jsonLd = {
  "@context": "https://schema.org",
  "@type": "WebApplication",
  "name": "Phone Total Cost Calculator",
  "description": "Calculate the estimated total cost of a phone with down payment, installments, interest, and accessories.",
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "Shoppers comparing phone payment plans, installments, accessories, and upfront costs"
  },
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does this include taxes and carrier fees?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Only if you add them to the phone price or accessory fields. Real offers may include taxes, activation fees, and plan charges."
      }
    },
    {
      "@type": "Question",
      "name": "Is the interest calculation exact?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. It is a simple estimate for comparison. Lenders and carriers may calculate financing differently."
      }
    },
    {
      "@type": "Question",
      "name": "Should I use this before buying a phone?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, it can help compare options, but always check the official contract and payment terms."
      }
    }
  ]
};
