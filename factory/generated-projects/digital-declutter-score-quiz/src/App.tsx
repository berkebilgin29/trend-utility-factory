...
const brief = {
  ...
  "inputs": [
    ...
    {
      "id": "inbox",
      "label": "Unread inbox count",
      "type": "number",
      "defaultValue": 80
    },
    {
      "id": "notifications",
      "label": "Notifications feel controlled",
      "type": "checkbox",
      "defaultValue": false
    }
  ],
  "outputs": [
    {
      "id": "score",
      "label": "Declutter score"
    }
  ],
  "faq": [
    {
      "question": "What does the score mean?",
      "answer": "It is a directional signal to help choose a cleanup starting point."
    },
    {
      "question": "Does it inspect my files or inbox?",
      "answer": "No. You enter values manually and nothing external is read."
    }
  ],
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  "name": "Digital Declutter Score Quiz",
  "description": "Score your digital clutter across tabs, inboxes, subscriptions, files, and notification habits.",
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "People reducing digital overload"
  },
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does the score mean?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It is a directional signal to help choose a cleanup starting point."
      }
    },
    {
      "@type": "Question",
      "name": "Does it inspect my files or inbox?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. You enter values manually and nothing external is read."
      }
    }
  ]
};
