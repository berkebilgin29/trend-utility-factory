...
const brief = {
  ...
  "inputs": [
    ...
    {
      "id": "decision",
      "label": "Decision needed is stated",
      "type": "checkbox",
      "defaultValue": false
    },
    {
      "id": "owners",
      "label": "Owners are assigned",
      "type": "checkbox",
      "defaultValue": false
    }
  ],
  ...
  "faq": [
    {
      ...
      "answer": "It is for anyone preparing meetings that will be summarized or actioned later."
    },
    {
      "question": "Does it replace meeting notes?",
      "answer": "No. It helps improve the structure before notes are captured."
    }
  ],
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  "name": "AI Meeting Readiness Checklist",
  "description": "Check whether a meeting has enough context, decisions, and follow-up structure for useful AI notes.",
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "Remote teams using AI note takers or meeting summaries"
  },
  "mainEntity": [
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It is for anyone preparing meetings that will be summarized or actioned later."
      }
    },
    {
      "@type": "Question",
      "name": "Does it replace meeting notes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. It helps improve the structure before notes are captured."
      }
    }
  ]
};
