...
const brief = {
  ...
  "inputs": [
    {
      "id": "streaming",
      "label": "Streaming apps monthly cost",
      "type": "number",
      "defaultValue": 25
    },
    {
      "id": "ai-tools",
      "label": "AI tools monthly cost",
      "type": "number",
      "defaultValue": 20
    },
    {
      "id": "cloud-apps",
      "label": "Cloud and creator tools monthly cost",
      "type": "number",
      "defaultValue": 15
    }
  ],
  ...
  "faq": [
    {
      ...
      "answer": "Include any recurring app, streaming, cloud, AI, creator, or membership payment."
    },
    {
      "question": "Is this financial advice?",
      "answer": "No. It is a simple planning estimate to help you review recurring costs."
    }
  ],
...
const jsonLd = {
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "People auditing recurring digital subscriptions"
  },
  "mainEntity": [
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Include any recurring app, streaming, cloud, AI, creator, or membership payment."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. It is a simple planning estimate to help you review recurring costs."
      }
    }
  ]
};
