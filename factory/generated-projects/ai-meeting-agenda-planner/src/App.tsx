...
const brief = {
  ...
  "faq": [
    {
      "question": "Can this be used without AI tools?",
      "answer": "Yes. It creates a human-readable agenda structure."
    },
    {
      "question": "Does it connect to my calendar?",
      "answer": "No. It runs locally and does not access external accounts."
    }
  ],
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  "name": "AI Meeting Agenda Planner",
  "description": "Draft a structured meeting plan with goal, context, decision, and follow-up blocks.",
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "Teams preparing concise meetings"
  },
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can this be used without AI tools?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. It creates a human-readable agenda structure."
      }
    },
    {
      "@type": "Question",
      "name": "Does it connect to my calendar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. It runs locally and does not access external accounts."
      }
    }
  ]
};
