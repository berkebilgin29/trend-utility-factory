...
const brief = {
  ...
  "description": "Generate a daily study plan from your exam timeline, subject count, and available study hours.",
  "keywords": [
    "study plan generator",
    "exam study planner",
    "daily study schedule"
  ],
  "audience": "Students preparing for exams, certifications, finals, and self-paced learning goals",
  "trendAngle": "Students are using lightweight planners to organize exam prep and avoid last-minute cramming.",
  "features": [
    "Daily study schedule",
    "Subject rotation prompt",
  ...
  "inputs": [
    ...
    {
      "id": "subjects",
      "label": "Number of subjects or topics",
      "type": "number",
      "defaultValue": 4
    },
    {
  ...
  "faq": [
    {
      "question": "Can this create a full exam calendar?",
      "answer": "It creates a simple daily planning estimate that you can copy into a calendar or task app."
    },
    {
      "question": "What if I have multiple exams?",
      "answer": "Use the closest or highest-priority exam first, then create separate plans for other exams."
    },
    {
      "question": "Does this guarantee better grades?",
      "answer": "No. It helps structure study time, but outcomes depend on preparation quality, course difficulty, and exam conditions."
    }
  ],
  "disclaimer": "This planner is an educational planning aid and does not guarantee academic results."
} as BriefData;
const jsonLd = {
  ...
  "audience": {
    "@type": "Audience",
    "audienceType": "Students preparing for exams, certifications, finals, and self-paced learning goals"
  },
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can this create a full exam calendar?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It creates a simple daily planning estimate that you can copy into a calendar or task app."
      }
    },
    {
      "@type": "Question",
      "name": "What if I have multiple exams?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Use the closest or highest-priority exam first, then create separate plans for other exams."
      }
    },
    {
      "@type": "Question",
      "name": "Does this guarantee better grades?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. It helps structure study time, but outcomes depend on preparation quality, course difficulty, and exam conditions."
      }
    }
  ]
};
